...
for sample in "${samples[@]}"; do
    for tag in "${tags[@]}"; do
        bam="/mnt/gtklab01/xiaoqing/2025-01-14/star/result/${sample%}/${tag}.sorted.bam"
        lst="/mnt/gtklab01/xiaoqing/2025-01-14-list_filter/analysis/${sample%}_${tag}.lst"
        filter_re="/mnt/gtklab01/xiaoqing/2025-01-14/filter/${sample%}_${tag}.bam"
        filter_bw="/mnt/gtklab01/xiaoqing/2025-01-14/filter/bw/${sample%}_${tag}.bw"
